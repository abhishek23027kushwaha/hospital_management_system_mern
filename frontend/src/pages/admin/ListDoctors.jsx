...
import { Search, Trash2, Edit2, Users, Loader2, Eye, EyeOff } from 'lucide-react';
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {loading ? (
              ...
              filtered.map((doc, i) => <DoctorRow key={doc._id} doc={doc} index={i} remove={remove} />)
            )}
          </tbody>
        </table>
      </div>
...
function DoctorRow({ doc, index, remove }) {
