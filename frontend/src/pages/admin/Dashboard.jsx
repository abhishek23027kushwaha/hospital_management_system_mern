...
import { Users, UserCheck, CalendarCheck, IndianRupee, CheckCircle2, XCircle, Search } from 'lucide-react';

const stats = [
  { label: 'Total Doctors',          value: 0,   icon: Users,          border: '#d1fae5', iconBg: '#f0fdf4', iconColor: '#16a34a' },
  { label: 'Total Registered Users', value: 21,  icon: UserCheck,       border: '#dbeafe', iconBg: '#eff6ff', iconColor: '#2563eb' },
  { label: 'Total Appointments',     value: 0,   icon: CalendarCheck,  border: '#fce7f3', iconBg: '#fdf2f8', iconColor: '#db2777' },
  { label: 'Total Earnings',         value: '₹ 0', icon: IndianRupee,  border: '#fef9c3', iconBg: '#fefce8', iconColor: '#ca8a04' },
  { label: 'Completed',              value: 0,   icon: CheckCircle2,   border: '#d1fae5', iconBg: '#f0fdf4', iconColor: '#16a34a' },
  { label: 'Canceled',               value: 0,   icon: XCircle,        border: '#fee2e2', iconBg: '#fef2f2', iconColor: '#dc2626' },
];
